...
<!-- Release baseline: v1.6.2 -->


## 1.6.3 공개베타

- DWMAP과 DWJB는 TM 위치를 먼저 클릭한 뒤 연속지적도 SHP와 비교하여 도면 좌표계를 자동 판정합니다.
- 실제 지역이 동부권이어도 중부원점으로 작성된 도면이면 중부원점을 추천합니다.
- 판정된 도면 좌표계와 변환 경도를 표시하고 사용자가 최종 확인하거나 변경할 수 있습니다.
- 설치 화면에 AutoCAD와 ZWCAD 종료 안내를 표시합니다.
- 기존 설치·업데이트·신뢰 위치·시작세트·메뉴 등록 방식은 1.6.2와 동일하게 유지합니다.
